...
declare type MantineDemoControlType = 'boolean' | 'color' | 'select' | 'string' | 'size' | 'number' | 'segmented';
...
export declare type MantineDemo = MantineCodeDemo | MantineConfiguratorDemo;
export {};
