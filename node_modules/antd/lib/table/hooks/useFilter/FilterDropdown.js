...
function FilterDropdown(props) {
  ...
  var internalTriggerFilter = function internalTriggerFilter(keys) {
    ...
    if ((0, _shallowequal["default"])(mergedKeys, filterState === null || filterState === void 0 ? void 0 : filterState.filteredKeys)) {
      return null;
    }
    triggerFilter({
      column: column,
  ...
  if (typeof column.filterDropdown === 'function') {
    ...
    var getResetDisabled = function getResetDisabled() {
      if (filterResetToDefaultFilteredValue) {
        return (0, _shallowequal["default"])((defaultFilteredValue || []).map(function (key) {
          return String(key);
        }), selectedKeys);
      }
